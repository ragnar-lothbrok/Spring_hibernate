...
"undefined") { a = typeof a == "object" ? Q(b, a) : a; return b.aoData[a]._aData } return V(b)
        }; this.fnGetNodes = function (a) { var b = A(this[n.iApiIndex]); if (typeof a != "undefined") return b.aoData[a].nTr; return R(b) };
...
$.fn.dataTableExt.oApi.fnGetHiddenTrNodes = function ( a )
{
	/* Note the use of a DataTables 'private' function thought the 'oApi' object */
	var anNodes = this.oApi._fnGetTrNodes( a );
	var anDisplay = $('tbody tr', a.nTable);
